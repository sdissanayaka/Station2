...
namespace Station2.Models
{
    public class MockItemRepository: IItemMasterRepository
    {
        ...
        public IEnumerable<ItemMaster> AllItems =>
            new List<ItemMaster>
            {
                new ItemMaster {ItemId = 1, ItemName="Strawberry Pie", Price=15.95M, ItemDescription="Lorem Ipsum", CategoryName = _categoryRepository.AllCategories.ToList()[0],InStock=true, IsItemOfTheWeek=false},
