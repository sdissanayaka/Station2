...
namespace Station2.Models
{
    public class MockItemRepository: IItemMasterRepository
    {
        ...
        public IEnumerable<ItemMaster> AllItems =>
            new List<ItemMaster>
            {
                new ItemMaster {ItemId = 1, ItemName="Engine oil", Price=12.95M, ItemDescription="Replace your engine oil", Category = _categoryRepository.AllCategories.ToList()[0],InStock=true, UOM="Litre", StockQuantity=500},
