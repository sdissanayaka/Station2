...
namespace Station2.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ItemMaster",
                columns: new[] { "ItemId", "CategoryId", "InStock", "ItemDescription", "ItemName", "Price", "StockQuantity", "UOM" },
                values: new object[] { 1, 1, true, "Replace your engine oil", "Engine oil", 12.95m, 500, "litre" });

            migrationBuilder.InsertData(
                table: "ItemMaster",
                columns: new[] { "ItemId", "CategoryId", "InStock", "ItemDescription", "ItemName", "Price", "StockQuantity", "UOM" },
                values: new object[] { 3, 1, true, "DSI", "Tyre", 33m, 100, "Units" });

            migrationBuilder.InsertData(
                table: "ItemMaster",
                columns: new[] { "ItemId", "CategoryId", "InStock", "ItemDescription", "ItemName", "Price", "StockQuantity", "UOM" },
                values: new object[] { 2, 2, true, "Cleaning the body of the car", "Body Wash", 120.90m, 0, null });
